           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    <img src="{{url('admin/img/janvi.jpg')}}" class="user-image img-responsive"/>
					</li>
				
					
                    <li>
                        <a  href="ad-index"><i class="fa fa-dashboard fa-3x"></i> Dashboard</a>
                    </li>
                      <li>
                        <a class="active-menu"   href="dashboard"><i class="fa fa-desktop fa-3x"></i> UI Elements</a>
                    </li>
                    <li>
